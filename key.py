...
#mail          : katana_sword89@protonmail.com
#latest update : 17-6-2020 11:53

#Open Source "free recode jingan :)"

#Asal sertakan sumbernya
#Source : https://github.com/karjok/terkey
...
Find Me
 ...
 Instagram : z3r0_ID
 Github    : https://github.com/MrCimin
 Email     : katana_sword89@protonmail.com
'''
...
os.system('clear')
z3r0('\033[1;37m[\033[1;31m!\033[1;37m] \033[1;33mDisclaimer \033[1;37m: ')
z3r0(' \033[0;37mDengan memakai tools ini tidak akan membuat anda menjadi hacker')
z3r0('Tools ini saya buat hanya untuk mempermudah para newbie')
z3r0('Dengan tools ini saya harapkan dapat membantu anda semua :)')
print('')
z3r0('Tools ini dibuat hanya untuk membantu orang bukan di gunakan untuk kejahatan cyber atau semacamnya')
sleep(5.0)
os.system('clear')
banner='''
 ...
 \033[0;37m/.-' 1.5 "     '-.\  \033[1;32mGithub \033[1;37m: \033[1;33mhttps://github.com/MrCimin
...
while True:
  ...
  print('')
  print('\033[1;37m[\033[1;32mU\033[1;37m]\033[1;33m.\033[0;35mUninstall Keys')
  print('\033[1;37m[\033[1;32mA\033[1;37m]\033[1;33m.\033[0;35mUpdate')
  print('\033[1;37m[\033[1;32mV\033[1;37m]\033[1;33m.\033[0;35mVisit github author')
  print('')
  ...
  if pil == '1':
    ...
    try:
      ...
      pass
    key = "extra-keys = [['F1','F2','F3','F4','F5','F6','F7'],['F8','F9','F10','F11','F12','BACKSLASH','ENTER'],['ESC','/','-','HOME','UP','END','PGUP'],['TAB','CTRL','ALT','LEFT','DOWN','RIGHT','PGDN']]"
    ...
    print('')
    print('')
    input("\033[1;32m[\033[1;31m!\033[1;32m] \033[1;33mENTER \033[1;32m[\033[1;31m!\033[1;32m]")
    print('\033[1;37m')
    break
  elif pil == '2':
    exit('\033[1;32m[\033[1;31mBye Bye :(\033[1;32m]')
    sleep(2.0)
    os.system('clear')
    print(banner)
    sleep(2.0)
    ...
    print(banner)
    sleep(2.0)
    os.system('termux-open-url "https://github.com/MrCimin"')
    os.system('clear')
    print(banner)
    sleep(2.5)
    break
